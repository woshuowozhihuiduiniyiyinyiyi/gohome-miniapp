...
public class JSONUtils
{
    ...
    public static <T> T toBean(Object object, Class<T> beanClass)
    {
        ...
        return (T) com.alibaba.fastjson.JSONObject.toJavaObject(jsonObject, beanClass);
    }
	...
	public static List<?> JSON2BEAN(String jsonString, @SuppressWarnings("rawtypes") Class clazz) {
		JSONArray array = JSONArray.fromObject(jsonString);
		@SuppressWarnings("rawtypes")
		List lst = new ArrayList();
		for (int i = 0; i < array.size(); i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			lst.add(JSONObject.toBean(jsonObject, clazz));
		}
		return lst;
	}
